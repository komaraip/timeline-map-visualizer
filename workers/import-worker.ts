...
import { detectSourceFormat, parserForFormat } from "../lib/timeline/parser";
import { emptyImportReport, type ImportReport, type ImportWarning, type TimelineEvent } from "../lib/timeline/types";
...
self.onmessage = (message: MessageEvent<{ type: string; files?: File[] }>) => {
