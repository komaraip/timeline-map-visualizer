...
vi.mock("../app/components/TimelineMap", () => ({ TimelineMap: () => <div aria-label="Interactive map of imported timeline data" /> }));
vi.mock("../app/components/JourneyVideoStudio", () => ({ JourneyVideoStudio: ({ onClose }: { onClose: () => void }) => <div role="dialog" aria-label="Journey Video Studio"><button type="button" onClick={onClose}>Close studio</button></div> }));

import { TimelineApp } from "../app/components/TimelineApp";
